...
class KeyCloakAdminClient:
    ...
    def __init__(self):
        ...
        self.server_url = getattr(settings, 'KEYCLOAK_SERVER_URL', 'http://localhost:8080')
    ...
    def create_user(self, email: str, username: str, first_name: str = "", 
                   ...
                   email_verified: bool = True) -> Optional[str]:
    ...
    def create_google_identity_provider(self, google_client_id: str, 
                                      google_client_secret: str) -> bool:
